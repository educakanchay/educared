		    ...
		    <a href="<?php echo $this->item->link; ?>" title="<?php if(!empty($this->item->image_caption)) echo K2HelperUtilities::cleanHtml($this->item->image_caption); else echo K2HelperUtilities::cleanHtml($this->item->title); ?>">
				...
				<?php 
					...
					if (!empty( $src)) {								
						...
						$thumb_img = yt_placehold($placehold_size['listing2'],$this->item->title,$this->item->title);
					}	
					echo $thumb_img;
				?>
				...
				<dd class="CommentsLink">
				      ...
				      <span class="catItemCommentsLink">
					      ...
					      <?php else: ?>
						      ...
						      <?php else: ?>
						      <a href="<?php echo $this->item->link; ?>#itemCommentsAnchor">
							    <i class="fa fa-comments"> </i><?php echo JText::_('ME_K2_THE_FIRST_TO_COMMENT'); ?>
						      </a>
						      <?php endif; ?>
					      <?php endif; ?>
				      </span>
				...
				<dd class="catItemAuthor">
					<?php if(isset($this->item->author->link) && $this->item->author->link): ?>
						<a rel="author" href="<?php echo $this->item->author->link; ?>">
						  <i class="fa fa-user"></i><?php echo $this->item->author->name ;?>
						</a>
						<?php else: ?>
  ...
  <div class="catItemBody">
	...
	<div class="catItemReadMore">
		<a class="k2ReadMore button" href="<?php echo $this->item->link; ?>">
			<?php echo JText::_('K2_READ_MORE_ME'); ?>
		</a>
	</div>
	<?php endif; ?>
