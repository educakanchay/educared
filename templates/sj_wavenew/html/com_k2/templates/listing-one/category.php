...
<div id="k2Container" class="itemListView grid<?php if($this->params->get('pageclass_sfx')) echo ' '.$this->params->get('pageclass_sfx'); ?>">
	...
	<div class="itemListCategoriesBlock">
		...
		<div class="itemListCategory">
			...
			<?php if($this->params->get('catTitle')):
				...
				$string_color1=strstr($this->category->name, "|" );
				$string_color2=str_replace("|", "#", $string_color1);
				$string_cate=str_replace($string_color1, "", $this->category->name);
			?>
			<!-- Category title -->
			<h2><?php echo $string_cate ?><?php if($this->params->get('catTitleItemCounter')) echo ' ('.$this->pagination->total.')'; ?></h2>
			<?php endif; ?>
		...
		<div class="itemListSubCategories row">
			...
			<div class="subCategoryContainer col-xs-12 col-sm-<?php echo number_format(12/$this->params->get('subCatColumns')) ?> <?php echo $lastContainer; ?>">
	...
	<div class="itemList">
		...
		<div id="itemListLeading" class="row">
			...
			<div class="itemContainer col-sm-<?php echo number_format(12/$this->params->get('num_leading_columns')) ?> <?php echo $lastContainer; ?>">
				<?php
