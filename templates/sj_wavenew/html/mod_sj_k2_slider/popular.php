											...
											<div class="catItemCategory"
												...
												<div class="arow-after"
												     ...
												     ></div>
                                                                                        ...
                                                                                        <?php if( (int)$options->item_readmore_display && ($options->item_readmore_text !='' )){ ?>
                                                                                        <div class="item-read">
                                                                        ...
                                                                        <aside class="article-aside">
                                                                                <dl class="article-info  muted">
                                                                                        ...
                                                                                        <dd class="catItemAuthor">
                                                                                                <a rel="author" href="<?php echo $item->authorLink; ?>">
                                                                                      ...
                                                                                      <!-- Item Hits -->
                                                                                        <dd class="catItemHitsBlock">
                                                                                                <span class="catItemHits">
                                                                                                        <i class="fa fa-eye"></i><?php echo $item->hits; ?><?php echo JText::_('JGLOBAL_HITS'); ?> 
