...
defined('_JEXEC') or die;
  ...
  if(!empty($list)){
	...
	echo '<div class="sj-highlight-items-show-tabs">';
		echo '<div class="sj-highlight-items-content-tabs"><div class="sj-highlight-items-content-tabs-border"></div></div>';
		echo '<div class="sj-highlight-items-content-item-tabs">';
			...
			foreach($tabs as $index=>$item){
				...
				echo '<div class="sj-highlight-items-content-tab'.$cls.'" data-title="'.htmlspecialchars($string_cate).'" data-content="'.htmlspecialchars($item['description']).'" data-id="'.htmlspecialchars($index).'">'.htmlspecialchars($string_cate).'</div>';
			}
		echo '</div>';
	echo '</div>';
	}
