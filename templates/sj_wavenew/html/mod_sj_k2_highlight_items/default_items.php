 ...
 */
	...
	$ts = ($width / 2) / $params->get('imgcfg_width');
	$small_image_config = array(
    'type' => $params->get('imgcfg_type_sm'),
    'width' => $params->get('imgcfg_width_sm'),
    'height' => $params->get('imgcfg_height_sm'),
    'quality' => 90,
...
?>
<div class="sj-highlight-items-loading" style="width:<?php echo $width;?>px;height:<?php echo $params->get('imgcfg_height')*$ts;?>px"></div>
...
jQuery(document).ready(function ($) {
	...
	<?php if($options->k2_highlight_items_chose_type_slide == 0 or ($widthW < 768)){?>
      ...
      var $progressBar,
		...
		<?php }?>
		$("#sj-highlight-items-for-k2-id-<?php echo $module->id;?> .k2_highlight_items_25").css('height',parseInt(<?php echo ($params->get('imgcfg_height')*$ts);?>)+'px');
		$("#sj-highlight-items-for-k2-id-<?php echo $module->id;?> .k2_highlight_items_50").css('height',parseInt(<?php echo ($params->get('imgcfg_height')*$ts);?>)+'px');
