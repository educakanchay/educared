...
<?php	
	...
	<div class="bsn-wrap theme3 row">
		<?php $count = 0; foreach ($list as $items) {
		 ...
		 ?>
		<div class="item post col-sm-<?php echo 12/count($list);  ?>">
			
			
			<a class="basicnews-title" title="<?php echo $items->title?>" target="<?php echo $options->item_link_target; ?>" href="<?php echo $items->link?>"><?php echo YTools::truncate($items->title,$options->item_title_max_characs);?></a>
				...
				<div class="bsn-image">
						...
						<a  class="alignleft" title="<?php echo $items->title?>" target="<?php echo $options->item_link_target; ?>" href="<?php echo $items->link?>">
							<?php	
								...
								else if ($is_placehold) {	echo yt_placehold($placehold_size['video_box'] );}								
							?>
			...
			<?php } ?>
				...
				<?php if ($options->item_desc_display == 1 ){?>
					<div class="basicnews-desc "><?php echo Ytools::truncate($items->description,$options->item_desc_max_characs);?></div>
				<?php } ?>
