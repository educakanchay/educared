  ...
  <ul>
	...
	<a class="k2Avatar moduleItemAuthorAvatar" rel="author" href="<?php echo $item->authorLink; ?>">
      ...
      <div class="moduleItemIntrotext">
		...
		<span class="moduleItemDateCreated"><i class="fa fa-clock-o"></i><?php echo JHTML::_('date', $item->created , 'j M Y'); ?></span>
		<?php endif; ?>
		<!-- Item Rating -->
	...
	?>
      <a class="moduleItemCategory" href="<?php echo $item->categoryLink; ?>"><?php echo $string_cate; ?></a>
      <?php endif; ?>
