...
<!--[if gt IE 9]><!--><div class="contact-ajax" id="<?php echo $tag_id; ?>" ><!--<![endif]--> 
	<div class="ctajax-wrap row">
		<div class="ctajax-element col-md-6 col-sm-6">
			<div class="el-inner">
				<h2 class="el-heading"><span><?php echo JText::_('AJAX_CONTACT_INFO');?></span></h2>
				<div class="el-map">
					<?php if($params->get('maps_display') == 1) { ?>
			...
			<div class="el-inner cf">
				<div class="el-form cf">
					...
					<form class="el-ctajax-form" id="el_ctajax_form" method="post" action="">
						...
						<?php } ?>	
						<div class="el-control">
							<input type="submit"  value="<?php echo JText::_('SEND_MAIL_LABEL_CONTACT_US'); ?>"  id="cainput_submit">
