...
class plgSystemYt extends JPlugin {
	...
	public function onBeforeCompileHead(){
		...
		$registration	= ($view == 'registration') ? true: false;
		...
		if($app->isSite()  && !$config_module  && !$comMedia &&  $disMootool && !$registration) {
	...
	function onAfterRender() {
		...
		//  Minify
		if($app->isSite() && $document->_type == 'html' && !($option == 'com_content' && $task =='edit')){
