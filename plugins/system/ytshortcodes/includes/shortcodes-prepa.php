...
function tabShortcode($atts, $content = null){
	...
	for($i = 0; $i < $num; $i ++) {
		...
		$tab = $tab . '<div id="' . $tab_id . $index_tab . '" class="tab-content-items clearfix ';
...
function vimeoShortcode($atts, $content = null){
	...
	preg_match('/https?:\/\/vimeo.com\/(\d+)$/', $content, $id);
